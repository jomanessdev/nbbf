...
export class EventsComponent implements OnInit {
  ...
  constructor() { 
    this.events = [
      {title:'Tuesday Night Bible Study',details:'Join us for a word from the Lord via Facebook Live Stream',time:'8:00 PM - 9:00 PM EST', date:'August 22', day:'Tuesday', location:'', source:'images/gallery/biblestudy.jpg'},
